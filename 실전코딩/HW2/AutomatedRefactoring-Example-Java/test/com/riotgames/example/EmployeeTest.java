...
import com.riotgames.example.Job;
import com.riotgames.example.Manager;
import com.riotgames.example.Programmer;
...
public class EmployeeTest {
	...
	public void noJobsDone() {
		Employee deadBeat = new Programmer();
		assertEquals(0, deadBeat.jobsCompletedCount());
		assertEquals(0, deadBeat.jobsSkippedCount());
	}
	...
	public void threeJobsPerformedNoneSkippedByProgrammer() {
		Employee productiveProgrammer = new Programmer();
	...
	public void oneJobDoneOneJobSkippedByProgrammer() {
		Employee unbusyProgrammer = new Programmer();
